...
import Cubo1 from './CuboVisit1';
import Flowcover1 from './CoverflowVisit1';
import FlipVisit1 from './FlipVisit1';
export default function Visitantesub1 (){
    return(
    <div className='App-visitante'>
            
            <p><h3>HISTORIA</h3>La aventura de Peugeot comienza en 1815 de la mano de Jean-Pierre Peugeot y Jacques Maillard-Salins. Ambos fundan una empresa que trabaja el acero y en el que, sobre todo, vendían sierras y relojes.
